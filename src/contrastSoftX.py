...
#        
        ...
        D = {'dirUs':dirUS.reshape(self.fwd.N,self.fwd.N), 'dirX':dirX.reshape(self.fwd.nRx,self.fwd.nRy), 'fooUs':fooUs.reshape(self.fwd.N,self.fwd.N), 'fooX':fooX.reshape(self.fwd.nRx,self.nRy)}
